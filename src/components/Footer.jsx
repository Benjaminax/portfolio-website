  ...
  return (
    <footer className="bg-white text-[#181A1B] pt-12 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-10 pb-8 border-b border-gray-200">
          {/* Logo & Description */}
          ...
          {/* Navigation Columns */}
          <div className="flex-1 grid grid-cols-2 xl:grid-cols-3 gap-8">
            <div>
