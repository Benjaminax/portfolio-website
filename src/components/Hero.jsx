  ...
  return (
    <section className="w-full max-w-[1800px] mx-auto min-h-[700px] flex flex-col xl:flex-row justify-between items-start px-4 md:px-[20px] pt-[60px] md:pt-[220px] relative">
      ...
      >
        ...
        >
          {/* GitHub icon */}
          <a href="https://github.com/Benjaminax" target="_blank" rel="noopener noreferrer">
          ...
          {/* LinkedIn icon */}
          <a href="https://www.linkedin.com/in/benjamin-acheampong-7274b12a1/" target="_blank" rel="noopener noreferrer">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="cursor-pointer">
